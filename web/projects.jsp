    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 1000px">
                                                        <c:url var="here" value="projects.jsp">
                                                            <c:param name="projectName" value="${project.projectId}"></c:param>
                                                        ...
                                                        <a href="#" data-toggle="modal" data-target="#myModal${vs.index}" data-id=" ${project.discription}"
                                                           ...
                                                           data-id5=" ${project.projectId}" data-url="${here}">${project.name}</a>
        ...
        <!--        <script>
                    $('#myModal').on('shown.bs.modal', function (event) {
                        ...
                        $("#sampleId1").html($(event.relatedTarget).data('id1'));
                        $("#sampleId2").html($(event.relatedTarget).data('id2'));
                        $("#sampleId3").html($(event.relatedTarget).data('id3'));
                        $("#sampleId4").html($(event.relatedTarget).data('id4'));
                         $("#sampleId5").html($(event.relatedTarget).data('id5'));
